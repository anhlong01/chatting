...
public class DeleteAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DeleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Email_value.isEmpty()) Toast.makeText(DeleteAccountActivity.this,"\n" +
                        "Ô trống",Toast.LENGTH_SHORT).show();
                else {
                    if(Email_value.equals(CurrentUserEmail)) AlertDialogMessage();
                    else Toast.makeText(DeleteAccountActivity.this,"\n" +
    ...
    private void AlertDialogMessage(){
        ...
        checkAlert.setMessage("Bạn có chắc chắn muốn xóa Tài khoản của mình không?")
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mProgressDialog.setMessage("\n" +
                        "vui lòng đợi trong khi chúng tôi Xóa tài khoản của bạn");
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(DeleteAccountActivity.this,"\n" +
                                    "tài khoản của bạn đã bị xóa thành công",Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(DeleteAccountActivity.this,"\n" +
                                    "Không xóa được tài khoản này",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
